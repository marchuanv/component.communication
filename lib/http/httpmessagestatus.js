...
HttpMessageStatus.prototype.getStatus = function(statusCode) {
    if (statusCode === 200) {
        return "Success";
    }
    if (statusCode === 201 ) {
...
HttpMessageStatus.prototype.getMessage = function(status) {
...
HttpMessageStatus.prototype.getCode = function(status) {
    const _statusStr = status.toString();
...
HttpMessageStatus.prototype.isSuccess = function(status) {
    return status.indexOf("Success") > -1;
};
HttpMessageStatus.prototype.isFail = function(status) {
    return status.indexOf("Fail") > -1;
};
module.exports = { HttpMessageStatus };