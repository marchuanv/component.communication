    ...
    */
    receive() {
        ...
        const errorPromise = new Promise((resolve, reject) => {
            eventEmitter.once('serverEvent', (error) => {
                if (error) {
                    reject(error);
                } else {
                    resolve();
            ...
            eventEmitter.once('clientEvent', (error) => {
                if (error) {
                    reject(error);
                } else {
                    resolve();
        ...
        const serverPromise = new Promise((resolve, reject) => {
            eventEmitter.once('serverEvent', (error, message) => {
                if (message) {
                    resolve(message);
                } else {
        ...
        const clientPromise = new Promise((resolve, reject) => {
            eventEmitter.once('clientEvent', (error, message) => {
                if (message) {
                    resolve(message);
                } else {
                    reject(new Error('critical error'));
