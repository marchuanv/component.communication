...
MessageStatus.prototype.getStatus = function(statusCode) {
    if (statusCode === 200) {
        return "Success";
    }
    if (statusCode === 201 ) {
...
MessageStatus.prototype.getMessage = function(status) {
...
MessageStatus.prototype.getCode = function(status) {
    const _statusStr = status.toString();
...
MessageStatus.prototype.isSuccess = function(status) {
    return status.indexOf("Success") > -1;
};
MessageStatus.prototype.isFail = function(status) {
