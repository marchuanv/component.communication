...
Communication.prototype.handle = function({ callback }) {
    if (callback instanceof CommunicationRequestHandlerCallback) {
        return await logging.write("component.communication", `unable to handle request on ${this.host}:${this.port}, callback is not of type CommunicationRequestHandlerCallback`);
    }
