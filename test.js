...
(async()=>{ 
    const componenTest = new Component({ moduleName: "component.test", gitUsername: "marchuanv" });
    const componentRequestHandler = new Component({ moduleName: "component.request.handler", gitUsername: "marchuanv", parentModuleName: "copmonent.test" });
    // component.delegate.register({ { name: "", overwriteDelegate = true }, callback })
