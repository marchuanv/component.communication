...
import { MessageHeaders, MessageHeadersCtorArgs } from "../lib/message.headers.mjs";
import {
    Connection,
    ConnectionCtorArgs,
    ConnectionOptions,
...
CtorArgsRegistry.register(new GUID('a31b8fc1-433c-46ad-b7fc-89e2e9a708ca'), MessageHeadersCtorArgs, MessageHeaders);
